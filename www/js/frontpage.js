...
function RefreshData()
{
	...
	if (vdata == 'Sunny' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Sunny","<img src=icons/day_sun.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Zonnig";
	}
	if (vdata == 'Partly Cloudy' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Partly Cloudy","<img src=icons/day_partlycloudy.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Gedeeltelijk bewolkt";
	}
	if (vdata == 'Cloudy' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Cloudy","<img src=icons/day_cloudy.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Bewolkt";
	}
	if (vdata == 'Clear' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Clear","<img src=icons/day_sun.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Helder";
	}
	if (vdata == 'Rain' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Rain","<img src=icons/day_rain.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Regen";
	}
	if (vdata == 'Snow' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Snow","<img src=icons/day_snow.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Sneeuw";
	}
	if (vdata == 'Fog' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Fog","<img src=icons/day_fog.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Mist";
	}
	if (vdata == 'Hail' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Hail","<img src=icons/day_hail.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Hagel";
	}
	if (vdata == 'Thunderstorm' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Thunderstorm","<img src=icons/day_thunderstorm.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Onweersbui";
	}
	if (vdata == 'Sleet' & IsNight == 'No') {
		vdata=new String(vdata).replace( "Sleet","<img src=icons/day_sleet.png width=100 height=1005 style='margin-top: -30px;'>");
		vdesc="IJzel";
	}
	...
	if (vdata == 'Sunny' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Sunny","<img src=icons/night_clear.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Helder";
	}
	if (vdata == 'Partly Cloudy' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Partly Cloudy","<img src=icons/night_partlycloudy.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Gedeeltelijk bewolkt";
	}
	if (vdata == 'Cloudy' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Cloudy","<img src=icons/night_cloudy.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Bewolkt"
	}
	if (vdata == 'Clear' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Clear","<img src=icons/night_clear.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Helder";
	}
	if (vdata == 'Rain' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Rain","<img src=icons/night_rain.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Regen";
	}
	if (vdata == 'Snow' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Snow","<img src=icons/night_snow.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Sneeuw";
	}
	if (vdata == 'Fog' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Fog","<img src=icons/night_fog.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Mist";
	}
	if (vdata == 'Hail' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Hail","<img src=icons/night_hail.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Hagel";
	}
	if (vdata == 'Thunderstorm' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Thunderstorm","<img src=icons/night_thunderstorm.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="Onweersbui";
	}
	if (vdata == 'Sleet' & IsNight == 'Yes') {
		vdata=new String(vdata).replace( "Sleet","<img src=icons/night_sleet.png width=100 height=100 style='margin-top: -30px;'>");
		vdesc="IJzel";
	}
